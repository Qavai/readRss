var ReadRss = {
    ...
    rss_load_xml: function (url, LastModified, Etag, callback) {
        ...
        if (is_load_as_text) {
            that.core.httpLoad(
                ...
                LastModified,
                Etag,
                function (text, LastModified, Etag, status, headers, responseURL) {
                    callback(that.core.rss.parseXml(text), text, LastModified, Etag, status, headers, responseURL);
                    text = null;
                },
            ...
            that.core.httpLoad(
                ...
                LastModified,
                Etag,
                function (xml, LastModifiedOut, EtagOut, status, headers, responseURL) {

                    that.core.funcs.mprint('load OK');
                    //that.core.funcs.mprint('responseURL = '+responseURL);
                    ...
                    callback(xml, "", LastModifiedOut, EtagOut, status, headers, responseURL);
                },
        ...
        that.core.Storage.feeds_get(
            ...
            function (feeds_list) {
                ...
                if (!feeds_list.length) {
                    ...
                    that.rss_load({ "url": feed_url, "eventKey": feed_id, "datetime": time_store_limit }, function (feedInfo, guid_index, items, events, LastModified, Etag, http_status, headers, responseURL) {
                        feed_process({ "url": feed_url, "eventKey": feed_id, "datetime": time_store_limit }, feedInfo, guid_index, items, events, LastModified, Etag, http_status, headers);
                        //!!! responseURL
                    });
                }
    ...
    rss_load: function (item, callback) {
        ...
        that.rss_load_parse(item.url_301 || item.url, item.eventKey, item.LastModified, item.Etag,
            function (feedInfo, guid_index, items, LastModified, Etag, http_status, headers, responseURL) {
                var i, l, c, e, g;

                if (!guid_index.length) {
                    callback(feedInfo, guid_index, items, [], LastModified, Etag, http_status, headers, responseURL);
                } else {
                    that.rss_insert_to_db(item.eventKey, item.datetime, feedInfo, guid_index, items, LastModified, Etag, http_status, headers, responseURL, callback);
                }
            }
        );
    },
        ...
        that.core.Storage.feeds_get(
            ...
            function (feeds_list) {
                ...
                that.rss_load_xml(
                    ...
                    LastModified,
                    Etag,
                    function (xml, text, LastModified, Etag, status, headers, responseURL) {

                        if (!xml || xml instanceof XMLHttpRequest) { //perhaps this feature of quo
                            callback(feedInfo, guid_index, items, LastModified, Etag, status, headers, responseURL);
                            return;
                        }
    ...
    rss_insert_to_db: function (feed_id, time_for_insert_item, feedInfoIn, guid_index, items, LastModified, Etag, http_status, headers, responseURL, callback) {
        var that = this;
                        ...
                        if (events.length > 0) {
                            ...
                            that.core.Storage.insert_msgs_getPrimaryKey('events', events, function (events_with_primaryKey) {
                                ...
                                that.core.calc_cache_icon_counts(function () {
                                    ...
                                    callback(feedInfo, guid_index, items, events, LastModified, Etag, http_status, headers, responseURL);
                                });
                            });
                        } else {
                            callback(feedInfo, guid_index, items, events, LastModified, Etag, http_status, headers, responseURL);
